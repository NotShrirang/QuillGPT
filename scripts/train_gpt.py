...
args.add_argument('--config', type=str, default='config/config.json',
                    help='Path to the config file')

args.add_argument('--data', type=str, default='data/corpus.txt',
                    help='Path to the data file')

args.add_argument('--name', type=str, default='GPT',
                    help='Name of the model')

args.add_argument('--save', type=str, default='trained_models',
...
(batch_size, block_size, max_iters, eval_interval, learning_rate, device,
    eval_iters, n_embd, n_head, n_layer, dropout, vocab_size) = gptutils.hyperparameters(config_path=config_path)
